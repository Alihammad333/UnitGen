...
describe("divide", () => {
  ...
  test("Normal behavior: positive numbers", () => {
    {
      const a = 6;
      const b = 2;
  ...
  test("Normal behavior: negative numbers", () => {
    {
      const a = -10;
      const b = 2;
      const result = divide(a, b);
  ...
  test("Safe invariant: division by zero", () => {
    {
      const a = 8;
      const b = 0;
  ...
  test("Simple parameterized behavior: small numbers", () => {
    {
      const a = 1;
      const b = 3;
      const result = divide(a, b);
  ...
  test("Safe invariant: result type", () => {
    {
      const a = 5;
      const b = 2;
      const result = divide(a, b);
  ...
  test("Normal behavior: decimal numbers", () => {
    {
      const a = 1.5;
      const b = 0.5;
      const result = divide(a, b);
